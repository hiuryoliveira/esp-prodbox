...
void loop(){
  ...
  if (ledState == LOW)
  {
    ...
    cont_aux_atu = (analogRead(analogInPin) < 200 ? 1 : 0);
...
ledState = LOW;
      ...
      timeout = 0;
      value++;
      snprintf (msg, 50, "Device:00004&Contador:%u&Epoch:%u%03u", value, epoch, epoch_millis);
    ...
    if (timeout == 600)//Envia mensagem para evitar desconex̣o
    {
      ...
      digitalWrite(ledPin, ledState);
      Serial.print(",");
      MQTT.publish("nxt/devices/sensors/prodbox", "Device:00004&controle");
      timeout = 0;
    }
  }
    }
